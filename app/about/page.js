...
const page = () => {
  return (
    <div className="bg-amber-50 text-gray-800 p-8 md:p-16">
      <div className="bg-[url('/images/About.jpg')] bg-cover bg-center relative text-white p-20 flex items-center justify-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center z-10">Our Story</h1>
      </div>
      <p className="text-lg md:text-xl mb-4 font-medium text-amber-700 text-center">Welcome To The India Restaurant</p>
